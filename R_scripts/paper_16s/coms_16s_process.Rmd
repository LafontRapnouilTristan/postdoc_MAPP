...
site_coord_nmds <- data.frame(sample=data_tmp$sample,
                              ...
                              nmds1_2prev=fortify(nmds_test$com_prev_2_relab_0)$NMDS1[1:202],
                              nmds2_2prev=fortify(nmds_test$com_prev_2_relab_0)$NMDS2[1:202],
                              nmds1_4prev=fortify(nmds_test$com_prev_4_relab_0)$NMDS1[1:202],
                              nmds2_4prev=fortify(nmds_test$com_prev_4_relab_0)$NMDS2[1:202],
                              nmds1_6prev=fortify(nmds_test$com_prev_6_relab_0)$NMDS1[1:202],
                              nmds2_6prev=fortify(nmds_test$com_prev_6_relab_0)$NMDS2[1:202],
                              nmds1_8prev=fortify(nmds_test$com_prev_8_relab_0)$NMDS1[1:202],
                              nmds2_8prev=fortify(nmds_test$com_prev_8_relab_0)$NMDS2[1:202],
...
site_data <- site_data_raw %>% filter(Sample%in%meco_16s$sample_table$Sample)%>%
    mutate(across(.cols= colnames(site_data),.fns = ~replace(., . ==  -9999 , NA)))
```
